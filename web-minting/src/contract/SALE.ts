const SALE_ABI: any = [
  {
    inputs: [
      ...
      { internalType: "uint64", name: "_maxSupply", type: "uint64" },
      { internalType: "uint256", name: "_maxWhitelistSize", type: "uint256" },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "bytes32", name: "merkelRoot", type: "bytes32" }],
    name: "SetMerkleRoot",
    type: "event",
  },
  {
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: "uint64", name: "totalSold", type: "uint64" },
          { internalType: "uint64", name: "ownerBought", type: "uint64" },
          { internalType: "uint64", name: "totalWhitelistSold", type: "uint64" },
          { internalType: "uint64", name: "totalPublicSold", type: "uint64" },
        ],
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: "uint64", name: "whitelistBought", type: "uint64" },
          { internalType: "uint64", name: "publicBought", type: "uint64" },
        ],
  ...
  },
  {
    ...
    outputs: [{ internalType: "address[]", name: "accounts", type: "address[]" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    inputs: [],
    name: "nft",
    outputs: [{ internalType: "contract ISipherNFT", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
