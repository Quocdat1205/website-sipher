...
const PrivateSale = ({ mode }: PrivateSaleProps) => {
  ...
  return (
    ...
    >
      <Typo.Heading fontSize="3xl">SIPHER NFT {mode === "PRIVATE_SALE" ? "PRIVATE SALE" : "FREE MINTING"}</Typo.Heading>
          ...
          <GridItem bg="blackAlpha.900" colSpan={1} rowSpan={1}>
            <Flex h="full" w="full">
              ...
              <SaleForm
                ...
                boughtNFT={mode === "PRIVATE_SALE" ? userRecord!.whitelistBought : userRecord!.freeMintBought}
                mode={mode}
              />
            </Flex>
          </GridItem>
