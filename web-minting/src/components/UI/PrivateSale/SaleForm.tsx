...
const SaleForm = ({
  ...
  const genTitle = () => {
    ...
    if (currentPhase === "ON_GOING") return mode === "PRIVATE_SALE" ? "Private Sale End Time" : "Free Minting End Time";
    if (currentPhase === "ENDED") return mode === "PRIVATE_SALE" ? "Private Sale Has Ended" : "Free Minting Has Ended";
  };
  return (
