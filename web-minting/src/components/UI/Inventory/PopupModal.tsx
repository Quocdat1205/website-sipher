          ...
          <Flex overflow="hidden" py="2%" flexDir="row">
            ...
            <Flex flexDir="column" flex="3" ml="4">
              ...
              <Box borderBottom="1px" borderColor="whiteAlpha.700" mt="4">
                <MyHeading display="flex" borderTop="1px" borderBottom="1px" borderColor="whiteAlpha.700" py="2">
                  Properties
                </MyHeading>
                <Box py="2">
                    ...
                    <Tbody>
                      {infoNFT.attributes.length > 0
                        ? infoNFT.attributes.map((item) => {
                            return (
                              <Tr key={item.value}>
                                <MyTd textTransform="capitalize" color="#EFE9D3" w="65%" textAlign="left" py="1" pl="0">
                                  . {item.trait_type} : {item.value}
                                </MyTd>
                                <MyTd color="#EFE9D3" w="20%" textAlign="left" py="1" pl="0">
                                  1 of {item.total}
                                </MyTd>
                                <MyTd color="#EFE9D3" w="15%" textAlign="right" py="1" pr="0">
              ...
              <Flex py="2" justifyContent="space-between" alignItems="center">
                ...
                <MyText color="teal.200">
                  {infoNFT.attributes.reduce((acc, current) => acc + Math.round(1000000 / current.total), 0) / 100}
                </MyText>
              </Flex>
            </Flex>
          </Flex>
          {infoNFT.attributes.length > 0 && (
            <Flex p="6" alignItems="center" justifyContent="space-between" border="1px" borderColor="whiteAlpha.500">
              {icon.map((item) => {
                return (
                  <>
