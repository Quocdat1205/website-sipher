...
const CommunityIcons = ({ size = "medium", ...props }: CommunityIconsProps) => {
  ...
  return (
    <HStack spacing={size === "small" ? 6 : 8} justify="center" {...props}>
      <Box as="a" cursor="unset" href="https://twitter.com/Sipherxyz" rel="noreferrer" target="_blank">
        <Img h={imgSize} src="/images/icons/twitter.png" alt="social-twitter" />
      </Box>
      <Box as="a" cursor="unset" href="https://discord.gg/sipherxyz" rel="noreferrer" target="_blank">
        <Img h={imgSize} src="/images/icons/discord.png" alt="social-discord" />
      </Box>
      <Box as="a" cursor="unset" href="https://medium.com/sipherxyz" rel="noreferrer" target="_blank">
