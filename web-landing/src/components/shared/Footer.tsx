  ...
  return (
    ...
    >
      ...
      <Stack
        ...
        w="full"
      >
        <Stack direction={["column", "column", "row"]} spacing={[2, 2, 4]} align={["center", "flex-start", "center"]}>
          ...
          <GradientText cursor="pointer" onClick={() => router.push("/term-and-conditions")} fontWeight="bold">
            Terms & Conditions
          </GradientText>
          <MyText
            fontWeight="thin"
