    ...
    >
      ...
      >
        ...
        >
          ...
          <GradientText size="small" cursor="pointer" onClick={() => router.push("/privacy-policy")} fontWeight="bold">
            Privacy Policy (IBCO)
          </GradientText>
          <Text
            fontWeight="thin"
          ...
          <GradientText size="small" cursor="pointer" onClick={() => router.push("/term-of-service")} fontWeight="bold">
