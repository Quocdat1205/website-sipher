...
const Select: FC<SelectProps> = ({
    ...
    const isOptionSelected = (option: Option) =>
        value && option[keyField] === value[keyField]
    ...
    const formatOption = (opt: Option) =>
        Object.values(opt)
            ...
            .join(" ")
    const selectionFilterer = (opt: Option) =>
        formatOption(opt).includes(searchText.toLowerCase())
    useEffect(() => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                {!readOnly && (
                    <Box>{isOpen ? <BsChevronUp /> : <BsChevronDown />}</Box>
                )}
            </Flex>
            <Box
                pos="absolute"
