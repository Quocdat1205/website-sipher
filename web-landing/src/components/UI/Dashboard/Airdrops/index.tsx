...
const Airdrops = () => {
  ...
  return (
    <>
      ...
      <Flex pos="relative" flexDir="column" px={4} flex={1} w="full" overflow="hidden" maxW="64rem" bg="transparent">
            ...
            {token?.totalAmount !== "0" && token ? (
              <>
                ...
                <Box my={4} bg="#F4B533" py={2} px={6} transform="skew(-5deg)">
                  <Text textAlign="center" fontSize="2xl" fontWeight={500} color="#282B3A" transform="skew(5deg)">
                    <chakra.span fontWeight={700}>{currency(weiToEther(token!.totalAmount))} $SIPHER</chakra.span>{" "}
                    Token(s) Airdrop
                  </Text>
                </Box>
