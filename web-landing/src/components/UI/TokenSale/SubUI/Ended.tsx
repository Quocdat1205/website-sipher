        ...
        <BackgroundContainer pos="relative" px={0}>
            <Flex pt={20} pb={16} flexDir="column" minH="100vh" align="center">
                <Box
                    pos="relative"
                    h="15rem"
                    bg="url(/images/banner-token.png)"
                    bgRepeat="no-repeat"
                    bgSize="100%"
                    w="full"
                >
                ...
                <Box w="full" maxW="58rem">
                    <Grid h="full" w="full" templateRows="repeat(2, 1fr)" templateColumns="repeat(2, 1fr)" gap={6}>
                        ...
                        <GridItem zIndex={2} p={8} rounded="xl" bg="rgba(0,0,0,0.9)" border="1px" borderColor="#383838">
                            <Stack spacing={4}>
                                ...
                                <Box>
                                    ...
                                    <Button
                                        onClick={() =>
                                            window.open("https://atlas.sipher.xyz/tokenomic/smart-contract", "_blank")
                                        }
                                        size="sm"
                                        fontSize="sm"
                                        _hover={{ bg: "#F4B533" }}
                        ...
                        <GridItem p={8} rounded="xl" bg="rgba(0,0,0,0.9)" border="1px" borderColor="#383838">
                            <Flex direction="column" w="full" h="full" justify="space-between">
                                <Flex align="center">
                                    ...
                                    <PopoverCustom
                                        color="black"
                                        bg="#FDF8E3"
                                        label="Eligible for participants of the $SIPHER PUBLIC SALE"
                                    >
                                        <Box cursor="pointer" color="#9091A0">
