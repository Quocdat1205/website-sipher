export const contentOverview = [
  {
    ...
    content: [
      "Players buy a or many Characters through our Smart Contract on ERC-721",
      "Having this Character allow Players to venture into Sipheria to conquer expeditions and embark on PvE and PvP gameplay",
      "The first ORIGIN release, the 1st Fleet Sipherian Surge, there will be 10,000 limited edition INU for sale",
      "Out of 10,000, 3000 extremely rare racial traits will be guaranteed to be limited forever, Sipher mad scientists will never construct more of these rare racial traits",
  ...
  },
  {
    ...
    content: [
      "At the beginning, there will be a first release of 10,000 Origin INUs under the 1st Fleet Sipherian Surge",
      "These origin INUs have special abilities, armor and equipment that are guaranteed limited editions on-chain",
      "Players can acquire these characters by purchasing them in our Laboratory",
    ],
  },
  {
    title: "Why limit it to 10,000 Origin INUs?",
    content: [
      "The first exploration is always a risky one",
      "Our mad scientists were only able to create the 1st Fleet capable of hosting 10,000 INUs on this daring first journey",
      "However, risks always come with rewards",
      "As the first explorers, our first adventurers will be entitled to acquire valuable resources and claim strategic land before the rest",
      "The early dog gets the bone so they say",
    ],
  },
  {
    title: "How can Players acquire new Sipher characters after 10,000 Origin INUs are sold out?",
    content: [
      "At the beginning, new players can choose to acquire from on the market from other players",
      "As the game progress, our laboratory will be ready to construct new INUs for players to acquire, however they will never be the same as the Origin INUs within the 1st Fleet Sipherian Surge",
      "Our mad scientists are hard at work on testing and constructing new and exciting characters for the world of Sipheria",
      "The projects are top secret and so far the only words we have heard were NEKO, BURU and TORI",
    ],
  },
  {
    title: "How can Players acquire new rare Sub-race Characters like Cyborg, Infected and Cosmic?",
    content: [
      "Unfortunately these characters are limited forever, as the creation progress from them were extremely difficult and pure chance",
      " We also heard from the grapevines that they are working on upgrading the Laboratory to allow for out of this world abilities like sequencing and forking the Origin characters",
    ],
  },
  {
    title: "Will Sipher the game be working on iOS and Android and other platforms?",
    content: [
      "We will develop on the mobile platform (iOS, Android) and we will work on integrating blockchain as seamless as possible",
    ],
  },
];

export const contentGameplay = [
  {
    title: "What are rewards for playing the game?",
    content: [
      "In game Leaderboard Ranking to claim status in the Hall of Fame",
      "Earn rewards, capture and conquer daily challenges for dual rewards ($ATHER & $SIPHER)",
      "Using $ATHER to craft, fuse, and own rare items and pets that will a part of your living legacy",
      "Earning $SIPHER through play, and become part of our community-based governance and a holder and benefactor of the game long term value creation",
      "In game NFT Prizes, Trophies",
    ],
  },
  {
    title: "How can players get In-game Costumes and Items?",
    content: [
      `When Players buy the Characters, they also receive 4 in-game Items: Helmet Body Armor Hand Armor Basic Background Each of these items have their individual Rarity all declared on-chain: for example "Great Hammer - FOREVER only 500 out of 10,000", Attributes that will affect the game play`,
      "Each of these items are seperate items and will be transferrable by the players to each other",
    ],
  },
  {
    title: "Expeditions gameplay",
    content: [
      "Players can send their Characters on Expeditions to tackle various challenging quests given by the Mad Scientists and Mercenary Guild in Moonbase Station",
      "If they complete these expeditions, they will receive various rewards in forms of: Limited Items and Costumes with different rarity that they can Wear or Trade to other players Materials Resources like ATHER Stones that they can use to level up their characters Laboratory materials called Vessel Core, to be used by the mad scientists for forking crazy experiments Expeditions Mechanic",
    ],
  },
  {
    title: "PvP and PvE gameplay",
    content: [
      "Players can play the game to receive: Limited Items and Costumes with different rarity that they can Wear or Trade to other players Unlimited Materials Resources like ATHER Stones that they can use to level up their characters Laboratory materials called Vessel Core, to be used by the mad scientists for forking crazy experiments $SIPHER tokens to be used to purchase a wide array of in-game items that will be released by the community and Sipher mad scientists Gameplay",
    ],
  },
  {
    title: "How can Players sell their items?",
    content: [
      "Players are all time OWN their Assets, including their In-game Items, character assets, character attributes linked to that assets, character Information such as Names, Level, Experience Points etc",
      "It is all stored on their Wallet On-chain Sipher will build Sipher Marketplace on ERC-721",
      "Users will pay gas and Sipher Marketplace Fee",
      "Players can sell their items via a Marketplace that will be built on ERC-721 Blockchain to other players, completely Permission less and trustless",
    ],
  },
  {
  ...
  {
    title: "Will there be a fee for selling items in the marketplace to other players?",
    content: [
      "Yes, there will be a Gas Fee and a 4% Marketplace Fee payable by the Seller to Sipher for creating and maintaining the marketplace",
    ],
  },
];
...
export const contentBlockchain = [
  {
    ...
    content: [
      ...
      "Each NFT, on the other hand, is completely unique",
  ...
  },
  {
    ...
    content: [
      ...
      "Every time the user interact with the game, they enter into a trust relationship where they will: Sign in with their Username and Password (and automatically connect their wallet)",
      ...
      "During the game, They can make buy transactions on the In-game client to buy items from Sipher",
      "This is put under [Sales Basket Order], temporarily holding off-chain until settled at log out",
      "Once user ****logs out, all the Activities will be settle On-chain with the User's Wallet",
