...
export const introduction: IPrivacyPolicyItem[] = [
    ...
    {
        level: 1,
        content: `Access or use our websites (including, our Sipher JSC website (" Sipher Website") at […]), applications (including mobile and web-based applications) (collectively, “Applications”) and services; and`,
    },
    {
        level: 1,
