export const KyberPoolAddress = "0xfba13b2a525d2b11c6c138a3a31040a663921213"

export const KyberPoolAbi: any = [
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: true, internalType: "address", name: "to", type: "address" },
            { indexed: false, internalType: "uint256", name: "feeInPrecision", type: "uint256" },
        ],
        name: "Swap",
        type: "event",
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: "uint256", name: "vReserve0", type: "uint256" },
            { indexed: false, internalType: "uint256", name: "vReserve1", type: "uint256" },
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: "uint256", name: "shortEMA", type: "uint256" },
            { indexed: false, internalType: "uint256", name: "longEMA", type: "uint256" },
            { indexed: false, internalType: "uint128", name: "lastBlockVolume", type: "uint128" },
            { indexed: false, internalType: "uint256", name: "skipBlock", type: "uint256" },
        ],
        name: "UpdateEMA",
        type: "event",
    },
    ...
    },
    {
        inputs: [],
        name: "factory",
        outputs: [{ internalType: "contract IDMMFactory", name: "", type: "address" }],
        stateMutability: "view",
        type: "function",
    },
    {
